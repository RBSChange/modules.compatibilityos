<?php
/**
 * commands_compatibilityos_UpdateOverride
 * @package modules.compatibilityos
 */
class commands_compatibilityos_UpdateOverride extends commands_AbstractChangeCommand
{
	/**
	 * @return String
	 */
	...
	function getParameters($completeParamCount, $params, $options, $current)
	{
		...
		{
			$components = array();
			foreach (glob("modules/compatobilityos/override/*", GLOB_ONLYDIR) as $module)
			{
